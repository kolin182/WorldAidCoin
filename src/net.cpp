...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "WorldAidCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {NULL, NULL},
	{"worldaidcoin.org", "worldaidcoin.org"}, {"162.13.95.28", "162.13.95.28"}
};
/*
static const char *strMainNetDNSSeed[][2] = {
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. WorldAidCoin is probably already running."), addrBind.ToString().c_str());
        else
